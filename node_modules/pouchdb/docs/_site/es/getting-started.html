      ...
      <div class="container">
        ...
        <ul class='nav nav-header nav-pills' role="navigation">
          <li>
              ...
              <a class='btn btn-link btn-lg' href="/getting-started.html" >English</a>
...
<p>We will start with a template of the project where all the data related functions have been replaced with empty stubs. Download and unzip <a href="/es/static/assets/pouchdb-getting-started-todo.zip">pouchdb-getting-started-todo.zip</a>. When dealing with XHR and IndexedDB you are better off running web pages from a server as opposed to a filesystem. To do this you can run:</p>
...
<p><a href="/es/static/img/screenshots/todo-1.png" target="_blank">
  <img class="img-responsive"  src="/es/static/img/screenshots/todo-1.png" alt="Todo Screenshot" />
</a></p>
...
<p><a href="/es/static/img/cors_in_couchdb.png" target="_blank">
  <img class="img-responsive"  src="/es/static/img/cors_in_couchdb.png" alt="CORS settings in CouchDB" />
</a></p>
