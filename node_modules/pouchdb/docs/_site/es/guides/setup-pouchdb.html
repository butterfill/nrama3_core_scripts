      ...
      <div class="container">
        ...
        <ul class='nav nav-header nav-pills' role="navigation">
          <li>
              ...
              <a class='btn btn-link btn-lg' href="/guides/setup-pouchdb.html" >English</a>
...
></a>
  ...
  <div class="container">
    ...
    <li >
    <a href="/es/guides/setup-couchdb.html">Setting up CouchDB</a>
</li>
    ...
    <li  class="active" >
    <a href="/es/guides/setup-pouchdb.html">Setting up PouchDB</a>
</li>
    ...
    <li >
    <a href="/es/guides/databases.html">Working with databases</a>
</li>
    ...
    <li >
    <a href="/es/guides/documents.html">Working with documents</a>
</li>
    ...
    <li >
    <a href="/es/guides/async-code.html">Asynchronous code</a>
</li>
    ...
    <li >
    <a href="/es/guides/updating-deleting.html">Updating/deleting documents</a>
</li>
    ...
    <li >
    <a href="/es/guides/bulk-operations.html">Bulk operations</a>
</li>
    ...
    <li >
    <a href="/es/guides/attachments.html">Working with attachments</a>
</li>
    ...
    <li >
    <a href="/es/guides/replication.html">Replication</a>
</li>
    ...
    <li >
    <a href="/es/guides/conflicts.html">Conflicts</a>
</li>
    ...
    <li >
    <a href="/es/guides/changes.html">Changes feed</a>
</li>
    ...
    <li >
    <a href="/es/guides/queries.html">Map/reduce queries</a>
</li>
    ...
    <li >
    <a href="/es/guides/compact-and-destroy.html">Compacting and destroying</a>
</li>
    ...
    <li >
    <a href="/es/guides/local-documents.html">Local documents</a>
</li>
...
<p>Download the latest <strong>pouchdb-3.6.0.min.js</strong> from the big green button above. Then in your <code>index.html</code>:</p>
<div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">&quot;pouchdb-3.6.0.min.js&quot;</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre></div>
<h2>Bower</h2>
...
<div class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;script </span><span class="na">src=</span><span class="s">&quot;//cdn.jsdelivr.net/pouchdb/3.6.0/pouchdb.min.js&quot;</span><span class="nt">&gt;&lt;/script&gt;</span>
</code></pre></div>
<h2>Node.js</h2>
