      ...
      <div class="container">
        ...
        <ul class='nav nav-header nav-pills' role="navigation">
          <li>
              ...
              <a class='btn btn-link btn-lg' href="/guides/replication.html" >English</a>
...
<a href="/es/static/img/offline_replication.gif" target="_blank">
  <img class="img-responsive"  src="/es/static/img/offline_replication.gif" alt="Offline replication with CouchDB." />
</a>
