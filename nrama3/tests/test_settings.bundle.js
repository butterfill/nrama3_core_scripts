...
var _settings = {
  ...
  db_url_base : '_design/nrama/_rewrite', 

  // -- user identification
  user_id : '*'+uuid(true).slice(0,10), //default to random anonymous user
...
},{"./lib/uuid":7,"jquery":5,"underscore":6}],9:[function(require,module,exports){
var $ = require('jquery');
